"""Script that finds name in dict"""
...
def main():
    ...
    name = classinfo["all"][9]["name"]
    skill = classinfo["all"][9]["skill level"]
    print(f"{name} has {skill} coding skills!\n")

    for student in classinfo["all"]:
        name = student["name"]
        skill = student["skill level"]
        animal = student["spirit animal"]
        power = student["super power"]
